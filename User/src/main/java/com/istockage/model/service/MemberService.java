...
public interface MemberService extends ServiceConstant {
	...
	/**
	 * @see com.istockage.model.service.MemberService#selectByMe_id(Integer)
	 */
	MemberEntity selectByMe_id(Integer me_id);

	/**
	 * @see com.istockage.model.service.MemberService#selectByMe_no(String, Byte)
	 */
	...
	/**
	 * @see com.istockage.model.service.MemberService#updateMe_random(MemberEntity)
	 */
	MemberEntity updateMe_random(MemberEntity memberEntity);
