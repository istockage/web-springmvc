											...
											<form:form id="securities-account-add-form" modelAttribute="securitiesAccountEntity" action="${requestMapping}" method="post">
												<fieldset>
													<div class="form-group">
														<label for="sh_no">證券商&nbsp;<span class="badge badge-subtle badge-danger">Required</span></label>
														<select id="sh_no" class="custom-select">
															<option value="0">請選擇</option>
															<c:forEach var="bean" items="${securitiesBrokerHeadList}">
																<option value="${bean.sh_no}">${bean.sh_name}</option>
															</c:forEach>
														</select>
